...
function PluginItem() {
	...
	/**
	 * If true, this plug-in group represents a vector art item created by tracing a raster art item. The tracing property contains the tracing object associated with the options used to create it.
	 * @type {boolean}
	 */
	...
	/**
	 * The position (in points) of the top left corner of the plugInItem object in the format [x, y]. Does not include stroke weight. array of 2 numbers 
	 * @type {array}
	 */
	this.position = [0, 0];
